...
import android.os.ParcelFileDescriptorHidden;
...
//                Log.d(TAG, "Opened " + rawPath + " for remote, fd " + fd.getInt$());
				return Refine.unsafeCast(new ParcelFileDescriptorHidden(fd));
			}
	...
	private @Nullable String sanitizeModulePath(String rawPath) throws IOException, ErrnoException {
