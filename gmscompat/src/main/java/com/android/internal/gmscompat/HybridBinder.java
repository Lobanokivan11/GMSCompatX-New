...
public final class HybridBinder implements IBinder {
	...
	public static @Nullable HybridBinder maybeCreate(@NonNull IBinder original) {
	...
	public void shellCommand(@Nullable FileDescriptor in, @Nullable FileDescriptor out, @Nullable FileDescriptor err,
	                         @NonNull String[] args, @Nullable ShellCallback shellCallback,
	                         @NonNull ResultReceiver resultReceiver) throws RemoteException {
		((IBinderHidden) original).shellCommand(in, out, err, args, shellCallback, resultReceiver);
	}
	...
	public IBinder getExtension() throws RemoteException {
		return ((IBinderHidden) original).getExtension();
	}
}
