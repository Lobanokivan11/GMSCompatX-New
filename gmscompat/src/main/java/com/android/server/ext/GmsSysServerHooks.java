...
public class GmsSysServerHooks {
	...
	public static void fixupPermissions(@NonNull ParsingPackage pkg) {
	...
	// ParsingPackageUtils#parseBaseApplication
	public static void maybeAddServiceDuringParsing(@NonNull ParsingPackage pkg) {
		...
		// GMSCompatX: re-sort services
		pkg.sortServices();
	}

	private static void addMediaProjectionService(@NonNull ParsingPackage pkg) {
		ParsedServiceImpl s = new ParsedServiceImpl();
		s.setPackageName(pkg.getPackageName());
